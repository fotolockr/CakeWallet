...
//        }
    ...
    private func onDepositCryptoChange(_ crypto: CryptoCurrency) {
        ...
        if store.state.walletState.walletType.currency == crypto {
            contentView.depositeCardView.pickerButtonView.walletNameLabel.text = store.state.walletState.name
            contentView.depositeCardView.addressContainer.textView.change(text: store.state.walletState.address)
            contentView.depositeCardView.pickerButtonView.walletNameLabel.isHidden = false
        } else {
            contentView.depositeCardView.pickerButtonView.walletNameLabel.isHidden = true
        }
...
//    }
    ...
    private func onReceiveCryptoChange(_ crypto: CryptoCurrency) {
        ...
        if store.state.walletState.walletType.currency == crypto {
            ...
            contentView.receiveCardView.pickerButtonView.walletNameLabel.isHidden = false
        } else {
            contentView.receiveCardView.pickerButtonView.walletNameLabel.isHidden = true
        }
